...
var g_headInfo = [
    ...
    '<img id="roamimg" src=""/>',
    '</li>',
    '<li id="card-status" class="info-img">',
    '<img id="cardimg" src=""/>',
    '</li>',
    '<li id="netmode" class="info-img">',
    '<img id="netmodeimg" src=""/>',
    '</li>',
    '<li id="signal-simg" class="info-img">',
    '<img id="signalimg" src=""/>',
    '</li>',
    '<li id="internet-mode" class="info-img">',
    '<img id="cradleimg" src=""/>',
    '</li>',
    '<li id="wifi-status" class="info-img">',
    '<img id="wifiimg" src=""/>',
    '</li>',
    '<li id="sms" class="info-img">',
    '<span id="sms_Num" class="sms_title"></span>',
    '<img id="smsimg" src="../images/message_tools.png"/>',
    '</li>',
    '</ul>',
    '<div class="bt_logout">',
    '<a id="logout" href=""></a>',
    ...
    '<a id="home" href="../common/home.html"></a>',
    '</div>',
    '<div class="bt_shortmessage" id="gotosms">',
    '<a id="shortmessage" href="../html/shortmessage.html"></a>',
    '</div>',
    '<div class="bt_settings" id="gotosetting">',
    '<a id="settings" href="../html/deviceinfo.html"></a>',
    '</div>',
    '</div>',
    '</div>',
    '</div>'];
